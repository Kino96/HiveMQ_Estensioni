...
public class TopicTreeMain implements ExtensionMain {
    ...
    public void extensionStart(final @NotNull ExtensionStartInput extensionStartInput, final @NotNull ExtensionStartOutput extensionStartOutput) {
        ...
        try {
            ...
            ///////////////////////////////
            /*log.info("rtt table:");
            for(String key : myRttTable.keySet())
                log.info("Address: " + key + " rtt: " + myRttTable.get(key));*/
        ...
        for(int i=0;i<subscriptionTable.size();i++){
            if(clientId.equals(subscriptionTable.get(i).getClientId())) {
                ...
                if(isNewTopicSub(topic)){
                    ...
                    String new_topic;
                    /*if(topicOverlays.get(topic).getRoot_address() != null)
                        if(topicOverlays.get(topic).getRoot_address().equals(own_address))
                            root_count--;*/
